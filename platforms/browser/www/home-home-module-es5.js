    ...
    function zpKS(module, __webpack_exports__, __webpack_require__) {
      ...
      var HomePage = /*#__PURE__*/function () {
        function HomePage(router, firestoreData, db, storage, navCtrl) {
          ...
          this.numberOfMessage = 0; //highlight icon in the header
          ...
          this.navigation = ["Buy by categories", "Wish List", "Recent Views", "Today Deals", "By Tomorrow", "Kindness", "Policy", "profil"]; //this.getBrowsingHistoric();
          //this.getLikeItems();
          //this.getSavedItems();
          ...
          this.slides$ = this.firestoreData.getMainSlides(); //this.brands = this.firebaseData.getBrandsDatabase();
          ...
          value: function getBrowsingHistoric() {
            ...
            this.storage.get("browsing").then(function (historic) {
              if (historic.length > 4 && historic !== null) {
                _this5.browsing = [historic[0], historic[1], historic[historic.length - 1], historic[2]];
              }
            })["catch"](function (err) {
              ...
              if (saved.length !== 0 && saved !== null) {
                ...
                try {
                  for (_iterator.s(); !(_step = _iterator.n()).done;) {
                    ...
                    _this7.savedItem.push(savedItem);
                  }
                } catch (err) {
                  _iterator.e(err);
                } finally {
