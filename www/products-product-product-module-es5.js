(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["products-product-product-module"], {
    ...
    function FOW(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_models_user__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! src/models/user */
      "Oj1a");

      var ProductPage = /*#__PURE__*/function () {
        function ProductPage(route, router, camera, afstore, afAuth, toastcontroller, firestoreData, storage, angularefireSG) {
        ...
        _createClass(ProductPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.data = {};
            this.data.models = [];
            var queryString = this.route.snapshot.params['kpuin'];
          ...
          value: function addInWishList(likeItem) {
            ...
            return this.storage.get("liked").then(function (liked) {
              if (liked === null || liked.length === 0) {
                ...
                var _iterator3 = _createForOfIteratorHelper(liked),
                    _step3;
              ...
              _this4.storage.set("liked", liked).then(function () {
              ...
              if (data === null || data.length === 0) {
                ...
                try {
                  for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
                    ...
                    if (_item.picture === _this5.dynamicPictures[0]) {
                      _item.qty = _this5.orderQty;
                      isAdded = true;
                    }
                  }
                } catch (err) {
            ...
            this.storage.get("user").then(function (uid) {
              if (!Object(util__WEBPACK_IMPORTED_MODULE_8__["isNullOrUndefined"])(uid)) {
                var navigationExtras = {
                  state: {
                    order: _this6.prepareOrder(args)
                  }
                };

                _this6.router.navigate(['/place-order'], navigationExtras);
              } else {
                ...
                _this6.router.navigate(['/login'], _navigationExtras);
              }
            });
          }
        }, {
              ...
              return regeneratorRuntime.wrap(function _callee4$(_context4) {
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      _context4.t0 = this.afstore.collection("user");
                      _context4.next = 3;
                    ...
                    case 3:
                      ...
                      _context4.t0.doc.call(_context4.t0, _context4.t1).get().subscribe(function (user) {
                        _this7.user = new src_models_user__WEBPACK_IMPORTED_MODULE_13__["User"](user.data());

                        if (_this7.reviewPicture !== '' && _this7.reviewPicture !== null) {
                          var filePath = _this7.user.name + new Date(Date.now());

                          var imageRef = _this7.angularefireSG.ref(filePath);

                          _this7.ngFireUploadTask = imageRef.putString(_this7.reviewPicture, 'data_url');

                          _this7.ngFireUploadTask.then(function (snap) {
                            console.log(snap.downloadURL);
                            _this7.reviewing = {};
                            _this7.reviewing.customerName = _this7.user.name;
                            _this7.reviewing.productId = _this7.data.code;
                            _this7.reviewing.reviewImage = _this7.reviewPicture;
                            _this7.reviewing.reviewText = text;
                            _this7.reviewing.reviewDate = new Date(Date.now());
                          });
                        } else {
                          _this7.reviewing = {};
                          _this7.reviewing.customerName = _this7.user.name;
                        ...
                        _this7.afstore.collection("review").add(_this7.reviewing);
                      });
            ...
            if (!Object(util__WEBPACK_IMPORTED_MODULE_8__["isNullOrUndefined"])(reference)) {
              ...
              this.storage.get("browsing").then(function (historic) {
                if (historic === null || historic.length === 0) {
                  ...
                  var _iterator5 = _createForOfIteratorHelper(historic),
                      _step5;
                ...
                _this8.storage.set("browsing", historic);
              });
            }
          }
        }, {
            ...
            this.storage.get("likeItems").then(function (liked) {
              if (liked !== null || liked.length !== 0) {
                liked.forEach(function (element) {
                  if (element.models[0].pictures[0] == _this9.data.models[0].pictures[0]) {
          ...
          value: function liked(reference) {
            ...
            this.storage.get("likeItems").then(function (liked) {
              if (liked === null || liked.length === 0) {
                ...
                var _iterator6 = _createForOfIteratorHelper(liked),
                    _step6;

                try {
                  for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
                    var _string = _step6.value;
              ...
              _this10.storage.set("likeItems", liked).then(function () {
