(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["verification-verification-module"], {
    ...
    /***/
    function IOxn(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function KwX(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      VerificationPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _verification_routing_module__WEBPACK_IMPORTED_MODULE_5__["VerificationPageRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"]],
    ...
    /***/
    function SIZt(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function c9mM(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var VerificationPage = /*#__PURE__*/function () {
        function VerificationPage(route, router, formBuilder, afs, loadingController, storage, afAuth, alertcontroller) {
        ...
        _createClass(VerificationPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.queryParams.subscribe(function (params) {
              if (_this.router.getCurrentNavigation().extras.state) {
                ...
                _this.user = _this.router.getCurrentNavigation().extras.state.info;

                _this.signin(_this.user);
              }
            });
          }
        }, {
          key: "sms_preference",
          value: function sms_preference() {
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      _context3.prev = 0;
                      _context3.next = 3;
                      return this.afAuth.createUserWithEmailAndPassword(user.email.trim(), user.password.trim());

                    case 3:
                      newUserCredential = _context3.sent;
                      _context3.next = 6;
                      return this.afs.doc("user/".concat(newUserCredential.user.uid)).set(user).then(function () {
                            ...
                            while (1) {
                              switch (_context2.prev = _context2.next) {
                                case 0:
                                  ...
                                  _context2.next = 3;
                                  return newUserCredential.user.sendEmailVerification();
                        ...
                        newUserCredential.user["delete"]();

                        _this2.msg_networkfailure();

                        _this2.storage.remove("user");
                      });

                    case 6:
                      return _context3.abrupt("return", newUserCredential);
          ...
          key: "msg_networkfailure",
          value: function msg_networkfailure() {
                  ...
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      ...
                      return this.alertcontroller.create({
                        ...
                        buttons: ['Ok']
                      }).then(function (alertview) {
                        alertview.present();
                        alertview.onDidDismiss().then(function () {});
          ...
          value: function verification() {
            ...
            this.afAuth.authState.subscribe(function (user) {
              if (user.emailVerified) {
                ...
                if (!Object(util__WEBPACK_IMPORTED_MODULE_10__["isNullOrUndefined"])(_this3.data)) {
                  _this3.router.navigate(['/place-order'], navigationExtras);
                } else {
